...
class TSNE:
    ...
    def run(self) -> np.array:
        ...
        for t in range(self.num_iterations):
            ...
            # Az iteráció elakadásának elkerülése érdekében minden tizedik iterációnál megnézzük,
            # hogy a síkbeli pontok hasonlóságának valószínűsége nem lett-e túl kicsi a további számolásokhoz
            if t % 10 == 0:
